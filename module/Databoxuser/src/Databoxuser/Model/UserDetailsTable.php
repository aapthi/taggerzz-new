...
class UserDetailsTable
{
	...
	public function updateHintingState( $userId,$hintingNewVal )
    {	
		$data = array(
			'hinting_state' 	 => $hintingNewVal
		);	
		$row=$this->tableGateway->update($data, array('user_id' => $userId));
		return $row;
	}
