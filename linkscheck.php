...
'youth.cn','youtube.com','zendesk.com','zhihu.com','zippyshare.com','zol.com.cn','zollow.com','ssl.gstatic.com');
			...
			foreach($urlsArrayy as $urlName){
				...
				$image = "https://taggerzz.com/public/images/montage_default_images/".$strLo.".png";
				echo $i.')'.$urlName." ---Image Name : ".$imageType." --- Image View :  <img  width='30' height='30' src='".$image."'><br/>";
				$i++;
			}
