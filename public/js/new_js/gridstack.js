...
(function (factory) {
    ...
    Utils.insert_css_rule(this._styles, '@media (max-width: ' + this.opts.min_width + 'px)', '.grid-stack-item { position: relative !important; width: auto !important; left: 0 !important; top: auto !important; margin-bottom: $vertical_padding; } .grid-stack-item .ui-resizable-handle { display: none; } .grid-stack { height: auto !important; }', 0);
